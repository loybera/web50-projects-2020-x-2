...
class Message:
    ...
    def __init__(self, user_from, user_to, time, post, user_from_img):
        # Keep track of id number.
    ...
    def __repr__(self):
        ...
        return (f"Message #{self.id} from {self.user_from} to: {self.user_to} in {self.time} post: {self.post} image:{self.user_from_img}")
